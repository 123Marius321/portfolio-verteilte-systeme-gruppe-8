...
export const updateSupplierByNumber = async (req, res) => {
    ...
    const updatedSupplier = new Supplier({number: req.params.number, companyName: req.body.companyName, delivery: req.body.delivery, deliveryDay: req.body.deliveryDay});
...
export const addSupplier = async (req, res) => {
    ...
    const supplier = new Supplier({number: req.body.number, companyName: req.body.companyName, delivery: req.body.delivery, deliveryDay: req.body.deliveryDay});
...
export const deleteSupplierByNumber = async (req, res) => {
    ...
    const deletedSupplier = new Supplier({number: result.number, companyName: result.companyName, delivery: result.delivery, deliveryDay: result.deliveryDay});
...
export const updateSupplierValidators = [
    ...
    ).withMessage('invalid deliveryDay - valid input: monday, tuesday, wednesday, thursday, friday, saturday, sunday')
];
